class Json_to_object(object):
    ...
    def __to_list(self):
        ...
        while self._str[self._counter] != ']':
            ...
            elif self._str[self._counter:self._counter + 4] == 'null':
                self._counter += 4
                buf_list.append(None)

            elif self._str[self._counter:self._counter + 4] == 'true':
                self._counter += 4
                buf_list.append(True)

            elif self._str[self._counter:self._counter + 4] == 'false':
                self._counter += 5
    ...
    def __to_object(self, dict_object):
        ...
        while True:
            ...
            if symbol == '\"':
                self._counter += 1
                key = self.__to_string(dict_object, key, is_key)
